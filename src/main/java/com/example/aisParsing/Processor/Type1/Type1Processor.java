...
public class Type1Processor implements Type1ProcessorService {
    ...
    public Type1Processor(MessageBuilder messageBuilder, CoordinateCalculateService coordinateCalculateService, JsonConverter jsonConverter, ITransmit iTransmit) {
